...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header text-center"> Registrar uma nova conta</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="user-type" class="col-md-4 col-form-label text-md-right">Tipo de Cadastro</label>

                            <div class="col-md-6">
                                <select class="form-control" name="user_type_id">
                                    <option value="1"> Jogador </option>
                                    <option value="2"> Cancha / Quadra / Clube </option>
                                </select>
                            </div>
                        </div>
                ...
                <div class="card-header text-right">
                    <a href="{{ route('login') }}"> Já tem conta? Logue-se. </a>
                </div>
            </div>
        </div>
    </div>
