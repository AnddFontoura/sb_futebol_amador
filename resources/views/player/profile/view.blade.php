...
@section('main_system')
    ...
    <div class="row">
        <div class="col-12 mb-3">
            <a href="{{ url('player/information/profile/edit') }}" class="btn btn-success float-right"> {{ __('basic.navigation.edit') }} {{ __('profile.name') }} </a>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-body p-0">
            <div class="row">
                <div class="col-12 mb-3">
                    <img src="{{ asset('img/bg_blue.png') }}" class="img w-100 shadow bg-body rounded" style="max-height: 200px;"></img>
                </div>

                <div class="col-md-2 col-lg-2 col-sm-12 img-profile">
                    <img class='img rounded-3' src="{{ asset('img/cr_7.png') }}" style="position: relative; width: 200px; top: -100px; left: 100px; border: 1px solid white;"></img>
                </div>
                ...
                <div class="col-md-9 col-lg-9 col-sm-12">
                    <h1> André Luis Scapin da Fontoura </h1>
                    <h5> Montanha </h5>
                    <h5> Curitiba -  Pr </h5>
                    <h5> (Goleiro / Zagueiro) </h5>
                    <h5> 31 anos </h5>
